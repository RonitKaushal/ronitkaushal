...
// --- Project list moved outside component ---
const projects = [
  // ======================== FUN PROJECTS ========================
  {
  ...
  {
    title: "Right Click Panel",
    description: "Another cool panel. Right-clickers, unite!",
    image: "/cetegoris/website/periodic.png",
    tags: ["HTML5", "CSS3", "JavaScript", "Website"],
  ...
  },
  {
    ...
    image: "/cetegoris/graphic_design/IBT ArtWork.png",
    tags: ["Graphic-Design"],
    url: "NaH",
  },
  {
    ...
    image: "/cetegoris/graphic_design/COD Poster.png",
    tags: ["Graphic-Design"],
    url: "NaH",
  },
  {
    ...
    image: "/cetegoris/graphic_design/Valorant poster CSGC.png",
    tags: ["Graphic-Design"],
    url: "NaH",
  },
  {
  ...
  },
  {
    ...
    image: "/cetegoris/graphic_design/Valorant CSGC.png",
    tags: ["Graphic-Design"],
    url: "NaH",
  },
  {
  ...
  },
  {
    ...
    image: "/cetegoris/graphic_design/Mini miletrea v2.png",
    tags: ["Graphic-Design"],
    url: "NaH",
  },
  {
    ...
    image: "/cetegoris/graphic_design/PowerBI event.png",
    tags: ["Graphic-Design"],
    url: "NaH",
  },
  {
    ...
    image: "/cetegoris/graphic_design/PowerBi Workshop New v2.png",
    tags: ["Graphic-Design"],
    url: "NaH",
  },
];
...
export default function FilteredProjectsPage() {
  ...
  return (
    <div className="relative flex justify-center items-center flex-col h-auto w-full mt-20 px-2 sm:px-4">
      ...
      {/* <div className="mt-5 flex flex-wrap justify-center items-center gap-2 w-full max-w-[1300px]">
        {uniqueTags.map((tag) => (
          <Badge
            key={tag}
            onClick={() => toggleTag(tag)}
            className={`sm:flex justify-center items-center max-w-[700px] text-background bg-foreground rounded-full hover:bg-red-500 text-md PoppinMedium p-2 px-5 transition-all duration-300 cursor-pointer ${
              selectedTags.includes(tag) ? "bg-red-500 text-background" : ""
            }`}
          >
            {tag}
          </Badge>
            ...
            <div className="pt-2 px-2 md:px-4">
              ...
              <div className="flex justify-start items-center w-full h-full flex-wrap gap-2 mb-3">
                {project.tags.map((tag, i) => (
                  <Badge
                    key={i}
                    className="PoppinMedium bg-accent text-primary"
                  >
                    {tag}
                  </Badge>
                ))}
